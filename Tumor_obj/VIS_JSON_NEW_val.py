...
def do_vis(svs_path,level=1):
    ...
    data=read_json(f'/home/zyj/SD/val/{name}.json')
    ...
    array_to_STAI(img_rgb_ds,f'/home/zyj/SD/val/vis/{name}.svs')


if __name__ == '__main__':
    all_svs_path=glob.glob('/home/zyj/SD/val/ST21Mm-MD-ML-PG-SD-550-1-00001.svs')
