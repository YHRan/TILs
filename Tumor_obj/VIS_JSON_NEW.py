...
def do_vis(svs_path,level=1):
    name=svs_path.split('/')[-1].split('.')[0]
    data=read_json(f'/home/zyj/SD/xianpao/infer_test_fu/my_json/{name}.json')
    ...
    array_to_STAI(img_rgb_ds,f'/home/zyj/SD/xianpao/infer_test_fu/vis/{name}.svs')


if __name__ == '__main__':
#     all_svs_path=glob.glob('/home/zyj/SD/xianpao/data/test/*.svs')
...
#     do_vis("/home/zyj/demo/klghs/data/pre_data/svs/*.svs")
